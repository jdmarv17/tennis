...
# 
rf1 <- randomForest(result ~ set_advantage + num_sets + game_advantage + num_games + break_advantage + point_dif + surface_numerical, data = train, ntree = 50, mtry = 4, importance = T)
...
# rf with all score
rf_allscore <- randomForest(result ~ all_score, data = train2, ntree = 100, mtry = 1, importance = T)
```
