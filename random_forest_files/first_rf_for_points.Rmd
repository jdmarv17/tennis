...
rf_mod_df <-
  rf_mod_df %>%
  filter(is.na(server_dist) == F & is.na(returner_dist) == F  & is.na(RallyCount) == F & is.na(Speed_MPH) == F & is.na(ServeSide) == F & is.na(hand) == F & is.na(height) == F & is.na(serve_number) == F & is.na(server_up) == F & is.na(servingplayer) == F & is.na(importance2) == F)
