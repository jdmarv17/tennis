...
atp_mod2 <- lmer(serverwin ~ importance + (1 + servingplayer | servingplayer), data = atp_small_df)
summary(atp_mod2)

#atp_mod3 has random intercept and slope for servingplayer and slam -- maybe surface improves model
atp_mod3 <- lmer(serverwin ~ importance + (1 + servingplayer | servingplayer) +
                   (1 + slam | slam), data = atp_small_df)
summary(atp_mod3)

# atp_mod4 has random intercept and slope for slam
atp_mod4 <- lmer(serverwin ~ importance + (1 + slam | slam), data = atp_small_df)
summary(atp_mod4)
```
