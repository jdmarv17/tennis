...
The neural network model now does better, but I'm not sure how particularly useful it is to be able to predict rally count from things like distance run. We can talk more about this when we meet.
