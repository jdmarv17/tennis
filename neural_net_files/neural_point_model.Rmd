...
# sample for training data
nn_train_df <- 
  nn_mod_df[sample(1:nrow(nn_mod_df), 7000, replace = FALSE), ]
...
```{r}
# fit model
serve_nn <- neuralnet(serve_width ~ serve_number + server_up + serve_side + Handedness + returnheight + hard_court + importance2 + Fed + Nadal + Novak + Milos + Nishikori + Stan + Thiem + Murray + Isner + Querrey + Edmund +
...
# (2423 + 2376) / 9526 = 0.503 (with importance2)
