...
## does this last filter solve the issue? if interested in serve metrics,
## would only care about points where the server was the same as the 
## player_num? Then would have a separate plot for returning?

## added returnerwin column to see opposite
...
ggplot(selected_players, aes(importance, Speed_MPH, color = player_name)) +
  geom_point()
# cant figure out where the 0's are coming from. Most aren't double faults so why are they recorded as 0 MPH?
```
