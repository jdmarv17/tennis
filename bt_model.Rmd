...
# atp mod with player and tournament
...
wta_mod1 <- BTm(cbind(win1, win2), player1 = winners_wta_df, player2 = losers_wta_df, formula = ~ id + first_serve:id + first_serve, id = "id", data = wta_decade_small)
